        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    @php
                        $productRoutes = ['admin.products.*'];
                        $specificationRoutes = ['admin.specifications.*'];
                        $portfolioRoutes = ['admin.portfolios.*'];
                    @endphp

                    <li class="nav-item {{ Route::is($productRoutes, $specificationRoutes, $portfolioRoutes) ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.specifications.index') }}" class="nav-link {{ Route::is('admin.specifications.*') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Product Specifications</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.portfolios.index') }}" class="nav-link {{ Route::is('admin.portfolios.*') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Portfolio</p>
                                </a>
                            </li>
