...
<header class="sticky top-0 z-50 bg-white/95 backdrop-blur border-b border-gray-200">
    ...
    <div class="flex items-center">
        <a href="/">
            <img src="{{ asset('images/logo.png') }}" 
                alt="SMESTICON Logo"
                class="h-10 sm:h-10 w-auto object-contain inline-block scale-[2.3] -translate-y-[6px]">
    ...
    <ul class="hidden md:flex items-center gap-6 lg:gap-8 text-xs sm:text-sm font-medium">
        <li>
            <a href="/" class="text-gray-700 hover:text-grey-orange transition">
                Beranda
            </a>
        </li>
        <li>
    ...
    <!-- Tombol Hubungi Kami -->
    <button
        class="hidden sm:block px-4 sm:px-5 py-2 sm:py-2.5 rounded-lg bg-grey-orange text-white text-xs sm:text-sm font-medium hover:bg-grey-orange-dark transition">
        Hubungi Kami
    </button>
