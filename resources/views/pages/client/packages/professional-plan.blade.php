      ...
      <div class="max-w-5xl mx-auto border-2 border-gray-200 rounded-2xl overflow-hidden hover:border-grey-orange transition-all duration-300">
        <div class="grid grid-cols-1 md:grid-cols-5 gap-0">
          <div class="md:col-span-2 bg-gray-50 p-6 sm:p-8 flex flex-col justify-center items-center text-center">
            ...
            <a href="https://wa.me/6285183258575?text=Halo%2C%20saya%20ingin%20berlangganan%20*PROFESSIONAL%20PLAN*%20dengan%20harga%20Rp%20750.000%2Fbulan.%0A%0AMohon%20informasi%20lebih%20lanjut%20untuk%20proses%20pembayaran%20dan%20aktivasi%20akun.%20Terima%20kasih!" target="_blank" rel="noopener noreferrer">
